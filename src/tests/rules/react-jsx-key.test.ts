...
describe('react-jsx-key', () => {
  ...
  it('should not error when key is provided in array map', async () => {
    const result = await lintHelper.fromContent(
      dedent`
        const items = ['a', 'b', 'c']
  ...
  it('should error on missing key in JSX fragment array', async () => {
    const result = await lintHelper.fromContent(
      dedent`
  ...
  it('should not error when key is provided in JSX fragment array', async () => {
    const result = await lintHelper.fromContent(
      dedent`
